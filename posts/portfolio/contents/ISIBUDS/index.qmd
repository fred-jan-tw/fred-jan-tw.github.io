...
- In this project, we analyzed data from a colorectal cancer study,  [Colorectal Cancer Detection Using Targeted Serum Metabolic Profiling](https://pubs.acs.org/doi/10.1021/pr500494u) and applied machine learning methods to predict the stage of colorectal cancer. 
...
![](Metabolomics_Project_Preserntation.pdf){ width="500px" height="1000px" }
